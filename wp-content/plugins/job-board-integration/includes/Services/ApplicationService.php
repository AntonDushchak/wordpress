...
class ApplicationService {
    ...
    public function update_application($application_id, $hash_id, $data) {
        try {
            ...
            // Отправляем в API только не-персональные данные
    ...
    /**
     * Генерация короткого уникального хеша
     */
